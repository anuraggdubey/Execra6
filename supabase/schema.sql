...
create table if not exists public.tasks (
    ...
    agent_type text not null check (agent_type in ('github', 'coding', 'document')),
...
comment on table public.tasks is 'Agent task history persisted for GitHub, coding, and document flows.';
