...
create table if not exists public.tasks (
    ...
    agent_type text not null check (agent_type in ('github', 'coding', 'document', 'email')),
...
comment on table public.tasks is 'Agent task history persisted for GitHub, coding, document, and email flows.';
